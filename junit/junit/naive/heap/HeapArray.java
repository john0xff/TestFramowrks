package junit.naive.heap;
import java.lang.reflect.Array;
import java.util.Arrays;
import java.util.Iterator;

/**
 * A HeapArray holds element on a priority heap, which orders the elements according to their natural order.
 * <p>
 * The heap data structure maintains the invariant that in its underlying tree structure the parent is less than all of
 * its children. This implementation maps the tree structure into an array which maintains the heap invariant such that
 * array[n] <= array[2*n] and array[n] <= array[2*n+1] for all elements in the array.
 * 
 * @param <E>
 *            the type of the objects stored in the array (must implement Comparable)
 */
public class HeapArray<E extends Comparable<E>> implements Iterable<E>
{
	...
	/**
	 * Returns a new array containing all the elements contained in the heap array.
	 * 
	 * @return the new array containing all the elements contained in the heap array
	 */
	...
	/**
	 * Returns an array containing all the elements contained in the heap array. If the specified array is large enough
	 * to hold the elements, the specified array is used, otherwise an array of the same type is created. If the
	 * specified array is used and is larger than the heap array, the array element following the heap array contents is
	 * set to null.
	 * 
	 * @param <T>
	 ...
	 * @return the new array containing the elements contained in the heap array.
	 */
	...
	/**
	 * Inserts target at position childIndex, maintaining heap invariant by promoting target up the tree until it is
	...
	/**
	 * Inserts target at position index, maintaining the heap invariant by demoting target down the tree repeatedly
